            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-1 leading-none">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Administratorem Państwa danych osobowych jest Impel Group Sp. z o.o. z siedzibą Powstańców Śląskich 17 D, 53-332 Wrocław. Twoje dane będą przetwarzane wyłącznie w celu obsługi Twojego żądania i tak długo, jak będzie to konieczne do obsługi Twojego żądania. Masz prawo dostępu do swoich danych, ich sprostowania, usunięcia, ograniczenia przetwarzania, sprzeciwu wobec przetwarzania i przenoszenia danych. Możesz również złożyć skargę do organu nadzorczego. Podanie danych jest opcjonalne, ale niezbędne do obsługi Państwa żądania. Podstawa prawna: art. 6 lit. b) (1) RODO - przetwarzanie jest niezbędne do podjęcia działań na żądanie osoby, której dane dotyczą, przed zawarciem umowy. W razie jakichkolwiek pytań prosimy o kontakt pod adresem: rodo@impelgroup.com.*
                </p>
              </div>
            </div>
